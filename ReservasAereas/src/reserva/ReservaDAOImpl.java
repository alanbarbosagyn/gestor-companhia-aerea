...
public class ReservaDAOImpl implements ReservaDAO {
	...
	public void gravar(Reserva reserva) throws ReservasDAOException {
        ...
        java.sql.Date horaReserva = new java.sql.Date(dataJava.getTime());
        hora.format(horaReserva);
        if (reserva == null)
	...
	public Reserva procurar(String codigo) throws ReservasDAOException {
        ...
        try {
            ...
            rs = ps.executeQuery();
            if (!rs.next()) {
                throw new ReservasDAOException("Erro ao procurar reserva!" + codigo);
            }
            reserva.setTipo(rs.getString("tipo"));
            reserva.setDataReserva(rs.getDate("datareserva"));
            reserva.setHoraReserva(rs.getDate("horareserva"));
	...
	public List listar(String email) throws ReservasDAOException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Date horaReserva = rs.getDate("horareserva");
                ...
                listReserva.add(new Reserva(codigo, tipo, dataReserva, horaReserva, numParcelas, 
                		numPassageiros, formaPagamento, Valor, codVooIda, codVooVolta, codAerpIda, 
                		codAerpVolta, clienteEmail));
            }
